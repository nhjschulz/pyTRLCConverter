...
pyTRLCConverter --source=..\..\doc\sw-requirements --source=..\..\doc\sw-test --source=..\..\doc\models --exclude=..\..\doc\sw-requirements --exclude=..\..\doc\sw-test --source=%OUT_DIR%\%TEST_RESULT_REPORT_TRLC% -o=%OUT_DIR% --verbose markdown
