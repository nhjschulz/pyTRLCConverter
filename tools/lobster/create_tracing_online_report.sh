...
SW_REQ_LOBSTER_ONLINE_REPORT_OUT=$OUT_DIR/lobster-online-report-sw-req.lobster
...
SW_TEST_LOBSTER_ONLINE_REPORT_OUT=$OUT_DIR/lobster-online-report-sw-rest.lobster
